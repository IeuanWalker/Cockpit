...
public class ContextService
{
	...
	public List<string> Branches { get; private set; } = ["main", "feature/new-ui", "bugfix/auth-issue"];
	public List<ContextFile> EditedFiles { get; private set; } = [];
	public List<string> AllowedCommands { get; private set; } = [];
	public List<string> AgentSkills { get; private set; } = [];
	...
	{
		if(!AllowedCommands.Remove(command))
		{
	...
	void NotifyContextChanged() => OnContextChanged?.Invoke();
}
