...
public class UIStateService
{
    ...
    // Dropdown states
    private readonly Dictionary<string, bool> _dropdownStates = new();
    ...
    public void ToggleDropdown(string dropdownId)
    {
        ...
        {
            _dropdownStates[dropdownId] = true;
        }
        NotifyStateChanged();
    }
    ...
    {
        return _dropdownStates.TryGetValue(dropdownId, out var isOpen) && isOpen;
    }
