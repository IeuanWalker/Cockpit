...
public class ChatService
{
    ...
    public void RemoveTypingIndicator()
    {
        ...
        var typingMessage = CurrentSession.Messages.FirstOrDefault(m => m.Type == MessageType.Typing);
    ...
    private void NotifySessionsChanged() => OnSessionsChanged?.Invoke();
    private void NotifyMessagesChanged() => OnMessagesChanged?.Invoke();
}
